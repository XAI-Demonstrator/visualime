...
from visualime._models import LINEAR_MODELS, MODEL_TYPE_DOC
...
DISTANCES_DOC = """distances : np.ndarray, optional
...
def predict_images(
    ...
    predict_fn : Callable
        A function that takes an input of shqpe `(num_of_samples, image_width, image_height, 3)`
